...
+ Перегрузка операторов + и - для добавления и удаления сотрудников в фирму, 
соответственно - При помощи экстеншена реализовать возможность узнать 
присутствует ли текущий экземпляр сотрудника в фирме(параметр)
